...
import ChartJsImage from 'chartjs-to-image';  // This is like a magical paintbrush for making charts!
...
/**
 * This is our magic function that can draw any chart
 * @param {object} config - This is the configuration for our chart
 * @return {Promise<string>} - This is the magic spell (Promise) that will give us a picture of our chart
 */
export async function createChart(config) {
  const chart = new ChartJsImage();
