...
import { writeTimestampedFile } from '../../utils/fileUtils.js';
import { log, logError } from '../../utils/loggerUtils.js';
import { asyncErrorHandler } from '../../utils/errorUtils.js';
import { getEnvVariable } from '../../utils/envUtils.js';
import { replacePlaceholders } from '../../utils/stringUtils.js';
import path from 'path';
import { z } from 'zod';  // This is our new friend that helps us define data structures
...
async function createStory() {
  ...
  const { filePath } = await writeTimestampedFile(`story_${MODEL_NAME}`, storyParts, logsDir);
